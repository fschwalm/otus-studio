describe('NewSurveyFormDialogService', function() {
    var Mock = {},
        TEMPLATE_URL = 'private/dashboard/survey-form/dialog/new-survey-form/new-survey-form-dialog.html';

    beforeEach(function() {
        module('studio');

        inject(function(_$injector_) {
            service = _$injector_.get('NewSurveyFormDialogService', {
